    ...
    >
      ...
      <div className="flex w-full align-center justify-center max-w-3xl items-center rounded-lg bg-gray-170 shadow-2xl">
        <textarea
          ...
          ref={otherRef}
          className="flex items-center justify-center w-full text-xs sm:text-md md:text-base rounded-lg border bg-primary border-accent placeholder-slate-400 text-white focus:outline-none resize-none whitespace-pre-wrap overflow-y-auto"
          autoFocus={false}
          rows={1}
          maxLength={2048}
          id="userInput"
